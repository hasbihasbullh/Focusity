...
export default function TimerSection() {
  ...
  useEffect(() => {
    ...
    setIsRunning(false); // Hentikan timer saat mode berubah
  }, [currentMode]);
    ...
    <div className="flex-1 flex items-center justify-center py-8">
      <div className="w-full max-w-md px-4 sm:px-0 text-center">
        ...
        <div className="mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-2xl font-semibold text-gray-700">What do you want to focus on?</h3>
        </div>

        {/* Mode Selection - Dinamis */}
