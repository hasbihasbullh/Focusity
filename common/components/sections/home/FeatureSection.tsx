  ...
  return (
    <section className="relative overflow-hidden py-20 px-6 lg:px-12 w-full" id="features">
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        <h2 className="text-4xl sm:text-5xl font-light text-zinc-900 dark:text-zinc-100 mb-6">Everything You Need to Stay Productive</h2>
        <p className="text-lg sm:text-xl text-zinc-500 dark:text-zinc-400 max-w-3xl mx-auto">Built for professionals who demand excellence in their productivity tools</p>
      </div>
      <div className="relative z-10 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Customizable work and break intervals with intelligent notifications and auto-progression</CardDescription>
        ...
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Organize your work with smart task lists, priorities, and completion tracking</CardDescription>
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-100/5 dark:from-zinc-700/5 to-zinc-200/5 dark:to-zinc-600/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </CardContent>
        </Card>
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Detailed insights into your productivity patterns with beautiful charts and reports</CardDescription>
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-100/5 dark:from-zinc-700/5 to-zinc-200/5 dark:to-zinc-600/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </CardContent>
        </Card>
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Capture ideas instantly with our integrated note-taking system and quick access</CardDescription>
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-100/5 dark:from-zinc-700/5 to-zinc-200/5 dark:to-zinc-600/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </CardContent>
        </Card>
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Curated collection of ambient sounds, nature recordings, and focus music</CardDescription>
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-100/5 dark:from-zinc-700/5 to-zinc-200/5 dark:to-zinc-600/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </CardContent>
        </Card>
        <Card className="group relative bg-zinc-100 dark:bg-zinc-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-zinc-300 dark:border-zinc-700">
          ...
          <CardContent>
            <CardDescription className="text-zinc-500 dark:text-zinc-400 leading-relaxed">Personalize your workspace with beautiful themes and customizable interfaces</CardDescription>
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-100/5 dark:from-zinc-700/5 to-zinc-200/5 dark:to-zinc-600/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </CardContent>
        </Card>
      </div>
